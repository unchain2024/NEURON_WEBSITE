...
/* it_6 — "See it on your workflow" CTA banner.
 *
 * Rebuilt from it_6.svg (design 1408×374, rx=8): the green texture is the
 * exported background (it6-bg.jpg), the grid + concentric rings are the exact
 * vector coordinates re-drawn as an inline SVG overlay, the halftone brain is
 * the downscaled raster (it6-brain.png), and the copy/button are real HTML so
 * they stay translatable. Type scales in cqw against the 1408px design width. */
export default function ITCta() {
  const t = useTranslations("CaseStudyIT.Cta");
      ...
      <div className="mx-auto w-[96%] max-w-[1800px]">
        <SectionReveal>
          <div className="relative hidden overflow-hidden rounded-2xl lg:block [container-type:inline-size]">
            ...
            <div
              className="absolute"
              style={{ left: "6.5%", top: "50%", transform: "translateY(-50%)", width: "46%" }}
            >
              <h2
              ...
              <p
                ...
                style={{ fontSize: "1.05cqw", lineHeight: 1.55, marginTop: "1.4cqw", maxWidth: "26cqw" }}
              >
                {t("body")}
              </p>
              <div className="flex items-center" style={{ gap: "1.7cqw", marginTop: "2cqw" }}>
                ...
                <Link
                  href={{ pathname: "/download", query: { industry: "information-technology" } }}
          ...
          {/* Mobile/tablet — light text section on top, green brain/rings image
              below (per wireframe). Desktop banner above is unchanged. */}
          <div className="relative overflow-hidden rounded-2xl border border-[#E9EAEB] lg:hidden">
            ...
            <div className="relative">
              <div className="px-6 pt-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-[#414651]">{t("body")}</p>
                <Link
                  href="/get-demo"
